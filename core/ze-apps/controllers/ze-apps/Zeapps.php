...
class Zeapps extends CI_Controller
{

    public function pagenotfound(){
        $data = [];

        $data['heading'] = 'Erreur 404';
        $data['message'] = 'La page que vous avez demandée n\'existe pas';
                        ...
                        if($folderJS = opendir($folderJsFile)) {
                            while (false !== ($folderItemJS = readdir($folderJS))) {
                                ...
                                if (is_file($fileJS) && $folderItemJS != '.' && $folderItemJS != '..' && $this->str_ends_with($folderItemJS, ".js")) {
                                    ...
                                    $this->recursive_mkdir(FCPATH . "assets/cache/js/" . $folderItem) ;

                                    // copie du fichier
                                    copy($fileJS, FCPATH . "assets/cache/js/" . $folderItem . "/" . $folderItemJS);

                                    $data["js_file"][] = "/assets/cache/js/" . $folderItem . "/" . $folderItemJS ;
                                }
                            }
                        }
                    }
                        ...
                        if($folderJS = opendir($folderCssFile)) {
                            while (false !== ($folderItemCss = readdir($folderJS))) {
                                ...
                                if (is_file($fileCSS) && $folderItemCss != '.' && $folderItemCss != '..' && $this->str_ends_with($folderItemCss, ".css")) {
                                    // creation du dossier d'accueil
                                    $this->recursive_mkdir(FCPATH . "assets/cache/css/" . $folderItem) ;

                                    // copie du fichier
                                    copy($fileCSS, FCPATH . "assets/cache/css/" . $folderItem . "/" . $folderItemCss);

                                    $data["css_file"][] = "/assets/cache/css/" . $folderItem . "/" . $folderItemCss ;
                                }
                            }
                        }
                    }
