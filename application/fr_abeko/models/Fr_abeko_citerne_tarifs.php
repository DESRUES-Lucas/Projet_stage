<?php
class Fr_abeko_citerne_tarifs extends MY_Model {
    ...
    public function get_by_id_tarif($listIdTarif = array())
    {
        ...
        else
        {
            ...
            $listId = "" ;
            for ($i = 0 ; $i < count($listIdTarif) ; $i++) {
                if ($listId != "") {
                    $listId .= ", ";
                }
                $listId .= $listIdTarif[$i];
            }

            if (count($listIdTarif) > 0) {
